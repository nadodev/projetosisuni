...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/users', function () {
        $users = User::where('role', '!=', 'user_admin')
    ...
    Route::prefix('forms')->name('forms.')->group(function () {
        ...
        Route::get('/{form}/responses', [FormController::class, 'responses'])->name('forms.responses');
    });
    ...
    Route::delete('/atribuir-turmas/{id}', [TurmaController::class, 'removerTurma'])->name('atribuir-turmas.remove');
    ...
    Route::prefix('students/{student}/progress')->name('students.progress.')->group(function () {
        Route::get('/', [\App\Http\Controllers\Admin\StudentProgressController::class, 'index'])->name('index');
        Route::get('/create', [\App\Http\Controllers\Admin\StudentProgressController::class, 'create'])->name('create');
        Route::post('/', [\App\Http\Controllers\Admin\StudentProgressController::class, 'store'])->name('store');
    });
    ...
    Route::prefix('reports')->name('admin.reports.')->group(function () {
        ...
        Route::get('/estudantes/pdf', [ReportController::class, 'exportEstudantesPDF'])->name('estudantes.pdf');

        // Professores
        Route::get('/professores', [ReportController::class, 'professores'])->name('professores');
        Route::get('/professores/pdf', [ReportController::class, 'exportProfessoresPDF'])->name('professores.pdf');
        ...
        Route::get('/usuarios-por-categoria/pdf', [ReportController::class, 'exportUsuariosPorCategoriaPDF'])->name('usuarios-por-categoria.pdf');
    });

    // Rotas de Anamneses
    Route::get('anamneses/{anamnese}/responses', [AnamneseController::class, 'responses'])
        ->name('anamneses.responses');
});
