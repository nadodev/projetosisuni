    ...
    <div class="py-8 px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-2 text-sm text-gray-500 mb-4">
                ...
                <i class="fas fa-chevron-right text-xs"></i>
                <span class="text-gray-700">Editar Instituição</span>
            </div>
            <h1 class="text-3xl font-bold text-gray-900">Editar Instituição</h1>
            <p class="mt-2 text-base text-gray-600">Atualize as informações da instituição no formulário abaixo.</p>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div class="relative">
                            ...
                            <div class="relative rounded-xl shadow-sm">
                                ...
                                <input type="text" name="telefone" id="telefone" value="{{ old('telefone', $instituicao->telefone) }}"
                                    class="pl-10 block w-full rounded-xl border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            ...
                            <div class="relative rounded-xl shadow-sm">
                                ...
                                <select name="uf" id="uf"
                                    ...
                                    @foreach(['AC', 'AL', 'AP', 'AM', 'BA', 'CE', 'DF', 'ES', 'GO', 'MA', 'MT', 'MS', 'MG', 'PA', 'PB', 'PR', 'PE', 'PI', 'RJ', 'RN', 'RS', 'RO', 'RR', 'SC', 'SP', 'SE', 'TO'] as $estado)
                                        <option value="{{ $estado }}" {{ old('uf', $instituicao->uf) == $estado ? 'selected' : '' }}>
                                            {{ $estado }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="relative rounded-xl shadow-sm">
                                ...
                                <select name="plan_id" id="plan_id"
                                    ...
                                    @foreach($plans as $plan)
                                        <option value="{{ $plan->id }}" {{ old('plan_id', $instituicao->plan_id) == $plan->id ? 'selected' : '' }}>
                                            {{ $plan->name }}
                                        </option>
                                    @endforeach
                                </select>
