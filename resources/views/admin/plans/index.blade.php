            ...
            <div>
                <div class="mb-4">
                    <p class="text-lg font-semibold">
                        Plano Atual: {{ auth()->user()->institution->plan->name ?? 'Nenhum plano selecionado' }}
                    </p>
                    <p class="text-lg font-semibold">
                        Convites Restantes: {{ auth()->user()->institution->plan->invite_limit - auth()->user()->institution->invites_used }}
                    </p>
                </div>
            </div>
        </div>
            ...
            @foreach($plans as $plan)
                <div class="overflow-hidden bg-white rounded-lg shadow">
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        @if(auth()->user()->institution->plan_id === $plan->id)
