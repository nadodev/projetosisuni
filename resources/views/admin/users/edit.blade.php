    ...
    <div class="max-w-3xl mx-auto">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-xl font-semibold text-gray-900">Editar Usuário</h1>
                <p class="mt-2 text-sm text-gray-700">Atualize os dados do usuário.</p>
            </div>
        </div>

        <form action="{{ route('admin.users.update', $user) }}" method="POST" class="mt-8 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
                <div class="px-4 py-6 sm:p-8">
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <select name="institution_id" id="institution_id"
                                    ...
                                    <option value="{{ $instituicao->id }}" {{ old('institution_id',
                                        $user->institution_id)==$instituicao->id ? 'selected' : '' }}>
                                        {{ $instituicao->nome }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <select name="role" id="role"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    <option value="">Selecione</option>
                                    <option value="user_admin" {{ old('role', $user->role)=='user_admin' ? 'selected' : ''
                                        }}>Administrador</option>
                                    <option value="user_teacher" {{ old('role', $user->role)=='user_teacher' ? 'selected' :
                                        '' }}>Professor</option>
                                    <option value="user_student" {{ old('role', $user->role)=='user_student' ? 'selected' :
                                        '' }}>Estudante</option>
                                </select>
                            </div>
                            @error('role')
                        ...
                        <!-- Senha -->
                        <div class="sm:col-span-3">
                            <label for="password" class="block text-sm font-medium leading-6 text-gray-900">Nova
                                Senha</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-3">
                            <label for="password_confirmation"
                                class="block text-sm font-medium leading-6 text-gray-900">Confirmar Nova Senha</label>
                            <div class="mt-2">
