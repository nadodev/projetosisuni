            ...
            <div class="prose prose-lg max-w-none">
                ...
                <section class="mb-8">
                    ...
                    <p class="text-gray-700 mb-4">
                        ...
                        Nossa coleta e uso de informações estão descritos em nossa 
                        <a href="{{ route('legal.privacy') }}" class="text-purple-600 hover:text-purple-700">Política de Privacidade</a>.
                    </p>
                </section>
