<header class="flex items-center justify-between bg-white shadow-md p-4">
    ...
    <div class="flex gap-4 items-center">
        <div class="gap-4 flex">
            <button
                class="text-lg bg-[#EFF4FB] border border-[#E2E8F0] h-8 w-8 p-4  flex justify-center items-center rounded-full">
                <i class="fa-regular fa-comment text-[#64748B]"></i>
            </button>

            <div class="relative">
                <div class="w-2 h-2 right-0 bg-[#DC3545] rounded-full absolute top-0" id="notificationBubble"></div>
                <button
                    class="text-lg bg-[#EFF4FB] border border-[#E2E8F0] h-8 w-8 p-4  flex justify-center items-center rounded-full">
