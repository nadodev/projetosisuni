...
<aside id="sidebar" class="sidebar grid  bg-[#1C2434] text-white p-4 transition-transform transform -translate-x-full md:translate-x-0">
    ...
    <nav class="mt-4 gap-y-4 flex flex-col">
      <a href="#" class="flex items-center gap-4 py-2 px-4 hover:bg-gray-600 bg-gray-600 text-[#DEE4EE]   rounded">
          <i class="fa-solid fa-house"></i>
          Página Inicial</a>
        
        <!-- Item com Submenu -->
        <div class="group">
            <a href="#" class="flex items-center gap-4 py-2 px-4 hover:bg-gray-600 text-[#DEE4EE]   rounded" onclick="toggleSubmenu('cadastroSubmenu')">
        ...
        <div class="group">
            <a href="#" class="flex items-center gap-4 py-2 px-4 hover:bg-gray-600  text-[#DEE4EE]   rounded" onclick="toggleSubmenu('relatoriosSubmenu')">
